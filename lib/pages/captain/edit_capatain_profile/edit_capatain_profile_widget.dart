...
import 'edit_capatain_profile_model.dart';
export 'edit_capatain_profile_model.dart';

class EditCapatainProfileWidget extends StatefulWidget {
  const EditCapatainProfileWidget({
    Key? key,
    this.editCaptain,
  }) : super(key: key);

  final RecruitersRecord? editCaptain;

  @override
  _EditCapatainProfileWidgetState createState() =>
      _EditCapatainProfileWidgetState();
}

class _EditCapatainProfileWidgetState extends State<EditCapatainProfileWidget> {
  late EditCapatainProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditCapatainProfileModel());

    _model.workerFullNameController ??=
        TextEditingController(text: widget.editCaptain!.fullName);
    _model.workersPhnController ??=
        TextEditingController(text: widget.editCaptain!.phone);
    _model.workersEmailController ??=
        TextEditingController(text: widget.editCaptain!.email);
    _model.refferalController ??=
        TextEditingController(text: widget.editCaptain!.referralCode);
    _model.adhaarNumberController ??=
        TextEditingController(text: widget.editCaptain!.aadhar);
    _model.workerPANController ??=
        TextEditingController(text: widget.editCaptain!.panNumber);
    _model.accountNameController ??=
        TextEditingController(text: widget.editCaptain!.accountName);
    _model.accountNumberController ??=
        TextEditingController(text: widget.editCaptain!.accountNumber);
    _model.bankNameController ??=
        TextEditingController(text: widget.editCaptain!.bankName);
    _model.ifscController ??=
        TextEditingController(text: widget.editCaptain!.ifscCode);
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Alert'),
                                                                  content: Text(
                                                                      'Chooose the area of the captain'),
                                                                  actions: [
                                                                    TextButton(
                                                                      onPressed:
                                                                          () =>
                                    ...
                                    if (FFAppState().pass == '0') {
                                      ...
                                      if ((_model
                                              ...
                                              _model
                                                      ...
                                                      .text !=
                                                  '') &&
                                          (_model.editaddressCaptainModel
                                                      .areadropdownValue !=
                                                  null &&
                                              _model.editaddressCaptainModel
                                                      .areadropdownValue !=
                                        ...
                                        if (_model.editaddressCaptainModel
                                                .areadropdownValue ==
                                            null) {
                                          await showDialog(
                                            context: context,
                                        ...
                                        final captainsUpdateData1 =
                                          ...
                                          pinCode: _model
                                              ...
                                              .pincodefieldController
                                              .text,
                                          area: _model.editaddressCaptainModel
                                              .areadropdownValue,
                                          district:
                                              FFAppState().disabling == '2'
                                                  ? widget.editCaptain!.district
                                                  : FFAppState().district,
                                          state: FFAppState().disabling == '2'
                                              ? widget.editCaptain!.state
                                              : FFAppState().state,
                                          aadhar: _model
                                              .adhaarNumberController.text,
                                          panNumber:
                                              _model.workerPANController.text,
                                          accountName:
                                        ...
                                        await widget.editCaptain!.reference
                                        ...
                                        context
                                            .pushNamed('CaptainsDashboardCopy');
