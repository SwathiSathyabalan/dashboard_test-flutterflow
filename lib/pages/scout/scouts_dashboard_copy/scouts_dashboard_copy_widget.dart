...
import 'scouts_dashboard_copy_model.dart';
export 'scouts_dashboard_copy_model.dart';

class ScoutsDashboardCopyWidget extends StatefulWidget {
  const ScoutsDashboardCopyWidget({Key? key}) : super(key: key);

  @override
  _ScoutsDashboardCopyWidgetState createState() =>
      _ScoutsDashboardCopyWidgetState();
}

class _ScoutsDashboardCopyWidgetState extends State<ScoutsDashboardCopyWidget> {
  late ScoutsDashboardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScoutsDashboardCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RecruitersRecord>>(
      stream: queryRecruitersRecord(
        queryBuilder: (RecruitersRecord) =>
            RecruitersRecord.whereIn('state', _model.stateCheckboxValues),
      ),
      builder: (context, snapshot) {
        ...
        List<RecruitersRecord> scoutsDashboardCopyRecruitersRecordList =
            snapshot.data!;
                                                                    ...
                                                                    children: [
                                                                      StreamBuilder<
                                                                        ...
                                                                        stream:
                                                                          ...
                                                                          queryBuilder: (RecruitersRecord) => RecruitersRecord.where('tag', isEqualTo: 'Scout').orderBy(
                                                                              'created_date',
                                                                              descending: true),
                                                                        ),
                                                                        builder:
                                                                          ...
                                                                          return ListView
                                                                            ...
                                                                            scrollDirection:
                                                                                Axis.vertical,
                                                                            itemCount:
                                                                                listViewRecruitersRecordList.length,
                                                                            itemBuilder:
                                                                                (context, listViewIndex) {
                                                                              final listViewRecruitersRecord = listViewRecruitersRecordList[listViewIndex];
                                                                              return Visibility(
                                                                                visible: functions.search(_model.textController.text, listViewRecruitersRecord.fullName!) ?? true,
                                                                                child: Padding(
                                                                                                    ...
                                                                                                    onPressed: () async {
                                                                                                      context.pushNamed(
                                                                                                        ...
                                                                                                        extra: <String, dynamic>{
                                                                                                          'scoutdetails': listViewRecruitersRecord,
                                                                                                        },
                                                                                                      );
                                                                                                    },
                                                                                                  ),
