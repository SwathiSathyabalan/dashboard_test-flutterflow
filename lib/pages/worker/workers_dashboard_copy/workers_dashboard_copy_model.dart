...
class WorkersDashboardCopyModel extends FlutterFlowModel {
  ...
  // State field(s) for genderCheckbox widget.
  List<String>? genderCheckboxValues;
  FormFieldController<List<String>>? genderCheckboxValueController;
  // State field(s) for SkillsCheckbox widget.
  List<String>? skillsCheckboxValues;
  FormFieldController<List<String>>? skillsCheckboxValueController;
