...
import 'jobaddress_model.dart';
export 'jobaddress_model.dart';

class JobaddressWidget extends StatefulWidget {
  const JobaddressWidget({Key? key}) : super(key: key);

  @override
  _JobaddressWidgetState createState() => _JobaddressWidgetState();
}

class _JobaddressWidgetState extends State<JobaddressWidget> {
  late JobaddressModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobaddressModel());
