...
import 'editaddress_captain_model.dart';
export 'editaddress_captain_model.dart';

class EditaddressCaptainWidget extends StatefulWidget {
  const EditaddressCaptainWidget({
    Key? key,
    this.area,
  }) : super(key: key);
  ...
  @override
  _EditaddressCaptainWidgetState createState() =>
      _EditaddressCaptainWidgetState();
}

class _EditaddressCaptainWidgetState extends State<EditaddressCaptainWidget> {
  late EditaddressCaptainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditaddressCaptainModel());
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (_) => EasyDebounce.debounce(
                                  ...
                                  () async {
                                    ...
                                    if ((LocationAPICall.namelist(
                                      ...
                                      _model.updatePage(() {
                                        FFAppState().arealist = (LocationAPICall
                                                .namelist(
                                          (_model.apiResultcci?.jsonBody ?? ''),
                                        ) as List)
                                ...
                                decoration: InputDecoration(
                                  ...
                                  contentPadding:
                                      EdgeInsetsDirectional.fromSTEB(
                                          10.0, 22.0, 20.0, 12.0),
                                  suffixIcon: _model.pincodefieldController!
                                          .text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                                            _model.pincodefieldController
                                ...
                                validator: _model
                                    .pincodefieldControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
