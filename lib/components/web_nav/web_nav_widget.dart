import 'package:jansakti_admin/backend/backend.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('CaptainsDashboardCopy');
                },
                child: Container(
                  width: double.infinity,
                  decoration: BoxDecoration(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (confirmDialogResponse) {
                                  ...
                                  await actions.disablenavigation();
                                } else {
                                  return;
                                }
