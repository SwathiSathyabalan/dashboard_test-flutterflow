...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/scoutsProfile',
          asyncParams: {
            'scoutdetails': getDoc(['Captains'], RecruitersRecord.serializer),
          },
          builder: (context, params) => ScoutsProfileWidget(
            scoutdetails: params.getParam('scoutdetails', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'EditOrgan',
        ...
        FFRoute(
          ...
          builder: (context, params) => WorkerJobsDashboardWidget(
            jobrefdetails: params.getParam('jobrefdetails',
                ParamType.DocumentReference, false, ['Organisations', 'Jobs']),
        ...
        FFRoute(
          ...
          path: '/captainProfile',
          asyncParams: {
            'captaindetails': getDoc(['Captains'], RecruitersRecord.serializer),
          },
        ...
        FFRoute(
          ...
          asyncParams: {
            'editCaptain': getDoc(['Captains'], RecruitersRecord.serializer),
          },
        ...
        FFRoute(
          ...
          builder: (context, params) => WorkersprofileWidget(
            workerdetails: params.getParam('workerdetails', ParamType.Document),
        ...
        FFRoute(
          ...
          asyncParams: {
            'editScout': getDoc(['Captains'], RecruitersRecord.serializer),
          },
        ...
        FFRoute(
          ...
          builder: (context, params) => JobsDashboardWidget(
            jobdetails: params.getParam('jobdetails', ParamType.Document),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'WorkersDashboardCopy',
          path: '/workersDashboardCopy',
          builder: (context, params) => WorkersDashboardCopyWidget(capDoc: params.getParam('capDoc', ParamType.Document),),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/scoutsDashboardCopy',
          builder: (context, params) => ScoutsDashboardCopyWidget(),
        ),
        FFRoute(
          name: 'JobDetails',
          path: '/jobDetails',
