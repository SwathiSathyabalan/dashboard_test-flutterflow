...
abstract class FlutterFlowTheme {
  ...
  late Color accent1Old;
  late Color accent2Old;
  late Color faded;
  late Color outlines;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF2A213);
  late Color secondary = const Color(0xFFFFD058);
  late Color tertiary = const Color(0xFFFFFBF4);
  ...
  late Color accent1Old = Color(0xFFF2A213);
  late Color accent2Old = Color(0xFFFFD058);
